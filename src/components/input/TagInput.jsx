  ...
  return (
   ...
   <div>
    ...
    <div className='flex items-center gap-4 mt-3'>
        <input type="text" value={inputValue}  className='text-sm bg-transparent border px-3 py-3 rounded outline-none' placeholder='Add Tags' onChange={handleInputChange}
